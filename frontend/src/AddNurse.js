...
const handleSubmit = async (event) => {
  ...
  formData.append("nr_id", data.nr_id);
  ...
  try {
    const res = await axios.post('http://localhost:8081/createNurse', {
  ...
  return (
    <div className='d-flex flex-column align-items-center pt-4'>
      ...
      <div className='col-12'>
            ...
            <input type='text' className='form-control' id='docId' placeholder='Enter nurse ID'
